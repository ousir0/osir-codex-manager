...
<p align="center">
  ...
  <a href="docs/user-guide-zh-CN.md">用户手册</a> ·
...
- [中文 / English 语言切换说明](docs/language-switching.md)
- [功能说明](docs/features.md)

需要 API 服务时，请进入独立的 [OSIR API 控制台](https://api.osirclaw.com)，或阅读
[OSIR API 文档](https://api.osirclaw.com/#docs)。Codex Manager 和 OSIR API 是两个不同的产品入口。
...
全球发布记录。网站对象镜像完成 promotion 后，再使用官网的最新下载链接：

| 平台 | 文件 | OSIR 镜像 |
|---|---|---|
| Apple Silicon Mac | `CodexManager_aarch64.dmg` | [下载 v0.5.6](https://github.com/ousir0/osir-codex-manager/releases/download/v0.5.6/CodexManager_aarch64.dmg) |
| Intel Mac | `CodexManager_x86_64.dmg` | [下载 v0.5.6](https://github.com/ousir0/osir-codex-manager/releases/download/v0.5.6/CodexManager_x86_64.dmg) |
| Windows x64 | `CodexManager_0.5.6_x64-setup.exe` | [下载 v0.5.6](https://github.com/ousir0/osir-codex-manager/releases/download/v0.5.6/CodexManager_0.5.6_x64-setup.exe) |
| Windows ARM64 | `CodexManager_0.5.6_arm64-setup.exe` | [下载 v0.5.6](https://github.com/ousir0/osir-codex-manager/releases/download/v0.5.6/CodexManager_0.5.6_arm64-setup.exe) |

当前正式版本为 v0.5.6。网站镜像推进到同一版本后，官网固定链接会恢复为最新版本入口；
在此之前，请使用上表中的 GitHub Release 精确资产。安装 Manager 后，Codex 本体由 Manager
负责安装与更新，不需要另找单独的 Codex 安装包。
...
Manager 会在启动和设定的时间间隔检查 `https://app.osirclaw.com/manager/latest.json`。发现新版本后，
会在任意页面显示更新提示；用户可以稍后提醒、跳过当前版本或立即安装。下载和安装前始终验证
Tauri updater 签名，更新完成后重启并确认目标版本。

完整的发布、更新和网站说明见 [Manager 自更新闭环](docs/manager-update-closure.md)。
...
| Platform | Mirror |
|---|---|
| Apple Silicon Mac | [CodexManager_aarch64.dmg v0.5.6](https://github.com/ousir0/osir-codex-manager/releases/download/v0.5.6/CodexManager_aarch64.dmg) |
| Intel Mac | [CodexManager_x86_64.dmg v0.5.6](https://github.com/ousir0/osir-codex-manager/releases/download/v0.5.6/CodexManager_x86_64.dmg) |
| Windows x64 | [CodexManager_0.5.6_x64-setup.exe](https://github.com/ousir0/osir-codex-manager/releases/download/v0.5.6/CodexManager_0.5.6_x64-setup.exe) |
| Windows ARM64 | [CodexManager_0.5.6_arm64-setup.exe](https://github.com/ousir0/osir-codex-manager/releases/download/v0.5.6/CodexManager_0.5.6_arm64-setup.exe) |

The current stable release is v0.5.6. Use the matching GitHub Release Assets until the website
mirror is promoted to the same version. Verify `SHA256SUMS` before running an installer. Preview Windows
