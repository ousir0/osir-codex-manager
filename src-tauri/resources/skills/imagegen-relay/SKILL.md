---
name: imagegen-relay
description: Generate or edit images through the user's separately configured third-party image API. Use only when the user has enabled relay image mode in Codex Manager.
---
