...
| `CodexManager_0.5.3_x64-setup.exe` | `5929a45abd2668afcff97d22664e282b21a6785252cee34a001853be93c1afd5` |
...
- 主二进制为 Apple Silicon arm64；Windows x64 安装器已通过 GitHub Actions 安装/升级/卸载冒烟测试。
